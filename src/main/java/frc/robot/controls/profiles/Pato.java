...
public class Pato implements ControlProfile {
  ...
  public void configureBindings(RobotContainer container) {
    ...
    controller.a().onTrue(new PivotRetractCommand(container.getPivot()));
                ...
                .runOnce(
                    () ->
                        container
                            ...
                            .resetPose(
                                new Pose2d(
                                    container.getDrive().getPose().getX(),
                                    container.getDrive().getPose().getY(),
